...
```json
{
    ...
    "quantity_exceeds_stock": "  Quantity cannot exceed available stock!",
    "quantity_cannot_be_zero": "  Please enter a quantity greater than 0"
}
```
...
```json
{
    ...
    "quantity_exceeds_stock": "  Menge kann nicht höher als verfügbarer Bestand sein!",
    "quantity_cannot_be_zero": "  Bitte geben Sie eine Menge größer als 0 ein"
}
```
