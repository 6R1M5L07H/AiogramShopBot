...
class NotificationService:
    ...
    @staticmethod
    def make_user_button(username: str | None) -> InlineKeyboardMarkup:
    ...
    @staticmethod
    def send_to_admins(message: str, reply_markup: types.InlineKeyboardMarkup):
        async def _send():
    ...
    async def new_deposit(deposit_amount: float, cryptocurrency: Cryptocurrency, fiat_amount: float, user_dto: UserDTO):
        ...
        user_button = NotificationService.make_user_button(user_dto.telegram_username)
        ...
        NotificationService.send_to_admins(message, user_button)

    @staticmethod
    async def new_buy(sold_items: list[CartItemDTO], user: UserDTO):
        user_button = NotificationService.make_user_button(user.telegram_username)
    ...
    async def order_created(order: OrderDTO, user: UserDTO) -> None:
        ...
        NotificationService.send_to_admins(admin_message, user_button)
